    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewDialogAdd.showDialog(RecyclerViewUsers.this);
            }
        });
    ...
    private void readData() {
        ...
        databaseReference.child("USERS").orderByChild("userName").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new UsersRecyclerAdapter(RecyclerViewUsers.this, usersItemArrayList);
            ...
            buttonAdd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (name.isEmpty() || email.isEmpty() || country.isEmpty()) {
                        Toast.makeText(context, "Vui lòng nhập tất cả dữ liệu...", Toast.LENGTH_SHORT).show();
                    } else {
